...
#include "yolov8_msgs/msg/detail/detection_person__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/string__functions.h"  // count_people
...
using _DetectionPerson__ros_msg_type = yolov8_msgs__msg__DetectionPerson;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DetectionPerson__ros_msg_type * ros_message = static_cast<const _DetectionPerson__ros_msg_type *>(untyped_ros_message);
  // Field name: inside
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DetectionPerson__ros_msg_type * ros_message = static_cast<_DetectionPerson__ros_msg_type *>(untyped_ros_message);
  // Field name: inside
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_yolov8_msgs__msg__DetectionPerson(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DetectionPerson__ros_msg_type * ros_message = static_cast<const _DetectionPerson__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DetectionPerson__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolov8_msgs__msg__DetectionPerson(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yolov8_msgs
size_t max_serialized_size_yolov8_msgs__msg__DetectionPerson(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolov8_msgs__msg__DetectionPerson;
    is_plain =
      (
...
static size_t _DetectionPerson__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yolov8_msgs__msg__DetectionPerson(
...
static message_type_support_callbacks_t __callbacks_DetectionPerson = {
  "yolov8_msgs::msg",
  "DetectionPerson",
...
static rosidl_message_type_support_t _DetectionPerson__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DetectionPerson,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolov8_msgs, msg, DetectionPerson)() {
  return &_DetectionPerson__type_support;
}
