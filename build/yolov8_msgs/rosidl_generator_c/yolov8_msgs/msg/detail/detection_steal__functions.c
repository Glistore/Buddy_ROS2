...
yolov8_msgs__msg__DetectionSteal__create()
{
  ...
  yolov8_msgs__msg__DetectionSteal * msg = (yolov8_msgs__msg__DetectionSteal *)allocator.allocate(sizeof(yolov8_msgs__msg__DetectionSteal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(yolov8_msgs__msg__DetectionSteal));
  bool success = yolov8_msgs__msg__DetectionSteal__init(msg);
  if (!success) {
...
yolov8_msgs__msg__DetectionSteal__destroy(yolov8_msgs__msg__DetectionSteal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    yolov8_msgs__msg__DetectionSteal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
yolov8_msgs__msg__DetectionSteal__Sequence__init(yolov8_msgs__msg__DetectionSteal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolov8_msgs__msg__DetectionSteal * data = NULL;

  if (size) {
    data = (yolov8_msgs__msg__DetectionSteal *)allocator.zero_allocate(size, sizeof(yolov8_msgs__msg__DetectionSteal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = yolov8_msgs__msg__DetectionSteal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        yolov8_msgs__msg__DetectionSteal__fini(&data[i - 1]);
      }
...
yolov8_msgs__msg__DetectionSteal__Sequence__fini(yolov8_msgs__msg__DetectionSteal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      yolov8_msgs__msg__DetectionSteal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolov8_msgs__msg__DetectionSteal__Sequence * array = (yolov8_msgs__msg__DetectionSteal__Sequence *)allocator.allocate(sizeof(yolov8_msgs__msg__DetectionSteal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = yolov8_msgs__msg__DetectionSteal__Sequence__init(array, size);
  if (!success) {
...
yolov8_msgs__msg__DetectionSteal__Sequence__destroy(yolov8_msgs__msg__DetectionSteal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    yolov8_msgs__msg__DetectionSteal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
yolov8_msgs__msg__DetectionSteal__Sequence__are_equal(const yolov8_msgs__msg__DetectionSteal__Sequence * lhs, const yolov8_msgs__msg__DetectionSteal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!yolov8_msgs__msg__DetectionSteal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  yolov8_msgs__msg__DetectionSteal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(yolov8_msgs__msg__DetectionSteal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    yolov8_msgs__msg__DetectionSteal * data =
      (yolov8_msgs__msg__DetectionSteal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!yolov8_msgs__msg__DetectionSteal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          yolov8_msgs__msg__DetectionSteal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!yolov8_msgs__msg__DetectionSteal__copy(
